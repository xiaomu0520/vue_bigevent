...
// 生产环境，打包时会以public/index.html作为模板生产dist/index.html，index.html中就有了那些cdn地址
// 开发环境,public/index.html也有那些第三方的cdn的地址，所以也能正常的运行，但是第一次的速度有点慢
// 所以开发环境还是项引入webpack引入本地的node_modules那些第三方的包
// process.env.NODE_ENV 可以根据敲击命令的不同，值也不同，能够一个代码区分不同环境

// 总结:
// 1.publicPath:影响的是打包(webpack开发服务器/dist)的时候index.html引入其他资源的前缀地址
// 情况1：开发环境，值：'/'
// 情况2：生产环境，值：'./' (才能确保dist/index.html相对路径访问)

// 2.dist瘦身：影响dist体积，其他第三方的包用cdn地址引入index.html中保证运行
// 情况1：开发环境，
//  （1）让externals无值（不排除第三方的包）
//  （2）index.html里不引入cdn的地址
// 情况2：生产环境
//  （1）：让externals有值（排除第三方的包）
//  （2）index.html里引入cdn的地址
